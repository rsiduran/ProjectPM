...
if (isset($_GET['regID'])) {
    ...
    if ($result) {
        ...
        if ($currentStatus === '2') {
            $updateQuery = "UPDATE `visitation` SET terms_accepted = '3' WHERE id = '$regID'";
            ...
            if ($result) {
                try {
                    ...
                    Your visitation <strong>' . htmlspecialchars($inmateName, ENT_QUOTES, 'UTF-8') . '</strong> has been completed.<br><br>
                    Here are the details of your approved visit:<br>
                    <strong>Visitor Name:</strong> ' . htmlspecialchars($nameUser, ENT_QUOTES, 'UTF-8') . '<br>
                    <strong>Inmate Name:</strong> ' . htmlspecialchars($inmateName, ENT_QUOTES, 'UTF-8') . '<br> 
                    For your next visitation please request to the system again.<br><br>
                    Thank you,<br>
                    ...
                    echo "<script>
                            ...
                            document.location.href = '../AdminSide/VisitationLogs.php';
                          </script>";
                } catch (Exception $e) {
                    echo "<script>
