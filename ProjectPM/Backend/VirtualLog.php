...
if (isset($_GET['regID'])) {
    ...
    if ($result) {
        ...
        if ($currentStatus === '2') {
            $updateQuery = "UPDATE `virtual` SET terms = '3' WHERE id = '$regID'";
            ...
            if ($result) {
                try {
                    ...
                    Your visitation request for <strong>' . htmlspecialchars($inmateName, ENT_QUOTES, 'UTF-8') . '</strong> has been completed.<br><br>
